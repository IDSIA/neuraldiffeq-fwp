...
# Exact split from https://github.com/tk-rusch/LEM/blob/main/src/eigenWorms/data.py
def train_test_val_split(tensors,
    ...
    train_val_test_split = train_test_split(*tensors, test_size=0.3, random_state=rnd_state)
    # list containing: train_x, test_x, train_y, test_y 
    train_data, val_test_data = train_val_test_split[0::2], train_val_test_split[1::2]

    val_test_split = train_test_split(*val_test_data, test_size=0.5, random_state=rnd_state)
    val_data, test_data = val_test_split[0::2], val_test_split[1::2]

    return train_data, val_data, test_data


def old_train_test_val_split(tensors,
                         val_frac=0.15,
                         test_frac=0.15,
                         stratify_idx=None,
                         shuffle=False,
